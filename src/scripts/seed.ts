...
async function run(): Promise<void> {
  ...
  if (existing > 0) {
    console.log(
      `User already has ${existing} essays — skipping. Delete them to re-seed.`,
    );
  ...
  const socialMedia = questionDocs.find((q) =>
    q.text.includes("social media"),
  )!;
  ...
  const evaluations = [
    {
      ...
      feedback:
        "Good arguments, but Coherence and Cohesion fell short due to weak transitions between paragraphs. Your vocabulary range is solid — keep it up.",
      tips: [
        "Use more linking words between paragraphs",
        "Develop each main idea with a clear topic sentence",
      ],
    ...
    },
    {
      ...
      feedback:
        "Data trends were accurately summarized with a clear overview. Lexical resource was precise and varied.",
      tips: [
        "Compare figures explicitly using fractions",
        "Add one more specific data point per paragraph",
      ],
    ...
    },
    {
      ...
      feedback:
        "The position is clear but arguments lack specific supporting examples. Watch out for repeated vocabulary.",
      tips: [
        "Provide 2-3 specific supporting details per argument",
    ...
    },
    {
      ...
      criteria: { ta: 7.0, cc: 7.0, lr: 7.0, gra: 7.0 },
      feedback:
        "Well-structured response with balanced coverage of both views. Cohesive devices used naturally.",
      tips: [
        "Strengthen the conclusion with a clear recommendation",
        "Use more advanced collocations",
      ],
    ...
    },
    {
      ...
      feedback:
        "Strong vocabulary usage and structural layout. Minor errors in punctuation only. Excellent task achievement.",
      tips: [
        "Watch comma placement in complex sentences",
        "Keep up the precise data description",
      ],
    ...
    },
    {
      ...
      criteria: { ta: 7.0, cc: 7.0, lr: 7.0, gra: 7.0 },
      feedback:
        "Clear improvement over the original draft — arguments are now backed by concrete examples and the flow is much smoother.",
      tips: [
        "Add a counter-argument paragraph for a higher TA score",
  ...
  const essays = [
    {
      ...
      questionId: socialMedia._id,
      question: { text: socialMedia.text, category: socialMedia.category },
      response:
        "Social media has transformed the way young people communicate...",
      wordCount: 284,
      durationSec: 2280,
    ...
    },
    {
      ...
      mode: EssayMode.Practice,
      questionId: lineGraph._id,
      question: { text: lineGraph.text, category: lineGraph.category },
      response:
        "The line graph illustrates population trends in three major Asian cities...",
      wordCount: 172,
      durationSec: 1080,
      status: EssayStatus.Evaluated,
    ...
    },
    {
      type: EssayType.Task2,
      mode: EssayMode.Exam,
      questionId: climate._id,
      question: { text: climate.text, category: climate.category },
      response:
    ...
    },
    {
      type: EssayType.Task2,
      mode: EssayMode.Practice,
      questionId: remoteWork._id,
      question: { text: remoteWork.text, category: remoteWork.category },
      response:
        "The shift towards remote work has accelerated dramatically in recent years...",
      wordCount: 291,
      durationSec: 2100,
      status: EssayStatus.Evaluated,
    ...
    },
    {
      type: EssayType.Task1,
      mode: EssayMode.Exam,
      questionId: barChart._id,
      question: { text: barChart.text, category: barChart.category },
      response:
        "The bar chart compares energy consumption across five European countries...",
      wordCount: 168,
      durationSec: 1200,
      status: EssayStatus.Evaluated,
    ...
    },
    {
      ...
      question: { text: socialMedia.text, category: socialMedia.category },
      response:
        "In recent years, social media platforms have become central to young people's daily lives...",
      wordCount: 298,
      durationSec: 2350,
      status: EssayStatus.Evaluated,
    ...
    },
    {
      ...
      questionId: remoteWork._id,
      question: { text: remoteWork.text, category: remoteWork.category },
      response: "Remote work arrangements have become increasingly common...",
      wordCount: 96,
      durationSec: 300,
  ...
  const original = created.find(
    (e) =>
      e.questionId?.equals(socialMedia._id) &&
      e.evaluation?.overallBand === 6.5,
  );
  const rework = created.find(
    (e) =>
      e.questionId?.equals(socialMedia._id) &&
      e.evaluation?.overallBand === 7.0,
  );
  if (rework && original) {
  ...
  console.log(
    `Seeded ${created.length} essays (6 evaluated, 1 draft, 1 rework chain) and ${questionDocs.length} questions.`,
  );
  await mongoose.disconnect();
}
